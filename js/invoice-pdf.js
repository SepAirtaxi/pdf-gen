...
async function generateInvoicePDF() {
    ...
    if (!generalData.from || !generalData.to || !generalData.date) { alert("Please select 'From', 'To' entities and Date."); return; }
    ...
    } catch (error) { console.error("Error saving invoice data:", error); alert("Error saving: " + error.message); return; }
    ...
    alert(`PDF "${generatedPdfFileName}" generated and data saved!`);
